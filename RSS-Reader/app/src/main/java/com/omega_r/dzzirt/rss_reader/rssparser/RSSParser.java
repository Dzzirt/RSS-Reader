package com.omega_r.dzzirt.rss_reader.rssparser;
...
public class RSSParser {
    ...
    public static List<FeedItem> parse(InputStream inputStream) throws IOException
                ...
                if (parser.getName() != null) {
                    ...
                    if (tag.equals(ITEM) && isValidItemTag(parser)) {
                        if (parser.getEventType() == XmlPullParser.START_TAG) {
                            m_isInItemTag = true;
                            tempItem = new FeedItem(); // creating temp item when we just enter <item>
                        } else {
                        ...
                        switch (tag) {
                            ...
                            case DESCRIPTION:
                                ...
                                break;
                            case AUTHOR:
                                tempItem.setAuthor(readText(parser));
                                break;
                            case ENCLOSURE:
                            ...
                            case PUBDATE:
                                ...
                                tempItem.setDate(DateUtils.parseRssDate(pubdate));
                                break;
                            case LINK:
                                tempItem.setUrl(readText(parser));
                                break;
                            case GUID:
